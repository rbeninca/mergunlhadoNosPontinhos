...
public class AlfabetoBraile {
    static ArrayList<Letra> alfabetoBraile=new ArrayList<>();
    static Letra marcadorNumero = new Letra("", new int[]{3, 4, 5, 6});
    static Letra marcadorMaiusculo = new Letra("", new int[]{7, 8, 9});
    ;
    ...
    public void carregaAlfabetoCompletoAZ() {
        //Carrega letras Braile

        alfabetoBraile.add(new Letra("A", new int[]{1}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("B", new int[]{1, 2}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("C", new int[]{1, 4}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("D", new int[]{1, 4, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("E", new int[]{1, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("F", new int[]{1, 2, 4}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("G", new int[]{1, 2, 4, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("H", new int[]{1, 2, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("I", new int[]{2, 4}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("J", new int[]{2, 4, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("K", new int[]{1, 3}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("L", new int[]{1, 2, 3}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("M", new int[]{1, 3, 4}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("N", new int[]{1, 3, 4, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("O", new int[]{1, 3, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("P", new int[]{1, 2, 3, 4}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("Q", new int[]{1, 2, 3, 4, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("R", new int[]{1, 2, 3, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("S", new int[]{2, 3, 4}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("T", new int[]{2, 3, 4, 5}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("U", new int[]{1, 3, 6}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("V", new int[]{1, 2, 3, 6}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("W", new int[]{2, 4, 5, 6}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("X", new int[]{1, 3, 4, 6}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("Y", new int[]{1, 3, 4, 5, 6}, marcadorMaiusculo));
        alfabetoBraile.add(new Letra("Z", new int[]{1, 3, 5, 6}, marcadorMaiusculo));
    }

    public void carregaAlfabetoCompletoaz() {
        alfabetoBraile.add(new Letra("a", new int[]{1}, null));
        alfabetoBraile.add(new Letra("b", new int[]{1, 2}, null));
        alfabetoBraile.add(new Letra("c", new int[]{1, 4}, null));
        alfabetoBraile.add(new Letra("d", new int[]{1, 4, 5}, null));
        alfabetoBraile.add(new Letra("e", new int[]{1, 5}, null));
        alfabetoBraile.add(new Letra("f", new int[]{1, 2, 4}, null));
        alfabetoBraile.add(new Letra("g", new int[]{1, 2, 4, 5}, null));
        alfabetoBraile.add(new Letra("h", new int[]{1, 2, 5}, null));
        alfabetoBraile.add(new Letra("i", new int[]{2, 4}, null));
        alfabetoBraile.add(new Letra("j", new int[]{2, 4, 5}, null));
        alfabetoBraile.add(new Letra("k", new int[]{1, 3}, null));
        alfabetoBraile.add(new Letra("l", new int[]{1, 2, 3}, null));
        alfabetoBraile.add(new Letra("m", new int[]{1, 3, 4}, null));
        alfabetoBraile.add(new Letra("n", new int[]{1, 3, 4, 5}, null));
        alfabetoBraile.add(new Letra("o", new int[]{1, 3, 5}, null));
        alfabetoBraile.add(new Letra("p", new int[]{1, 2, 3, 4}, null));
        alfabetoBraile.add(new Letra("q", new int[]{1, 2, 3, 4, 5}, null));
        alfabetoBraile.add(new Letra("r", new int[]{1, 2, 3, 5}, null));
        alfabetoBraile.add(new Letra("s", new int[]{2, 3, 4}, null));
        alfabetoBraile.add(new Letra("t", new int[]{2, 3, 4, 5}, null));
        alfabetoBraile.add(new Letra("u", new int[]{1, 3, 6}, null));
        alfabetoBraile.add(new Letra("v", new int[]{1, 2, 3, 6}, null));
        alfabetoBraile.add(new Letra("x", new int[]{2, 4, 5, 6}, null));
        alfabetoBraile.add(new Letra("y", new int[]{1, 3, 4, 6}, null));
        alfabetoBraile.add(new Letra("z", new int[]{1, 3, 4, 5, 6}, null));
    ...
    public void carregaNumeros() {
        ...
        alfabetoBraile.add(new Letra("6", new int[]{1, 2, 4},marcadorNumero));
